...
% function wavwrite_append(s, fn, chunk_size, fs, nbits)
% code to generate long wav files by breaking them into smaller chunks
% s = sound vector
% fn = file name
% chunk_size = number of samples to write per chunk (defaults to 1 million)
% fs = sampling frequency
% nbits = bit depth of output file
...
if ~exist('fs','var') || isempty(fs)
    error('You need to specify the sample rate, fs!');
end
